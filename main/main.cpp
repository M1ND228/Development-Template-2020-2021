...
void Menu(Polinom& p1, Polinom& p2, Polinom& res)
{
	...
	std::cout << "1) Сложить полиномы" << std::endl;
	std::cout << "2) Вычесть полиномы" << std::endl;
	std::cout << "3) Перемножить полиномы" << std::endl;
	std::cout << "4) Посчитать результат" << std::endl;
